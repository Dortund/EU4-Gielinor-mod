...
NGame = {
	START_DATE = "1930.6.1",
	END_DATE = "2301.1.1",
	MAX_RANDOM_NEW_WORLD = "1950.1.1",

	GREAT_POWER_FRENZY_START = "2169.1.1",	-- Latest date for the start of the Great Power Frenzy (struggle).
...
NDiplomacy = {
	...
	HRE_HERETIC_PENALTY = -0.003,					-- Per heretic prince (halved by Peace of Westphalia)
	...
	AE_THREATEN_WAR = 1.0,
	AE_PRIMITIVES = 0.0, -- less AE from primitives
...
NCountry = {
	...
	CULTURAL_UNION_MIN_DEV = 800,				-- Minimum development to get cultural union effect without Common Sense, or if CULTURAL_UNION_MIN_RANK is set to negative value.
	...
	MIN_DEVELOPMENT_FOR_GOV_RANK_3 = 800,		-- Need at least this much development to upgrade to government rank 3
	...
	VICTORY_CARD_START_YEAR = 1950,			-- first year for victory card.
	...
	PS_DEMAND_NON_WARGOAL_PEACE_PRIMITIVES = 2.5,
...
NFrontend = {
	...
	FRONTEND_POS_X = 2900.0,
	FRONTEND_POS_Y = 900.0,
	FRONTEND_POS_Z = 1098.0,
	FRONTEND_LOOK_X = 2900.0,
	FRONTEND_LOOK_Y = 0.0,
	FRONTEND_LOOK_Z = 1098.0,
