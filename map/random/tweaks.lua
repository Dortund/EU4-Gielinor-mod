...
RandomWorld = {
	...
	options = {
		width				= 1280,
		height				= 2048,
		overlapping_sea_province_search_width = 1408, -- Any sea province that overlaps with the randomized area needs to be removed from the provincemap, overlapping_sea_province_search_width is the rightmost edge of the area of the provincemap that will be searched for these provinces
